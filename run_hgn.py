...
#-----------------------------------------------------------------------------------------------------------------------------
    ...
    parser.add_argument("--bert_model", default='BENT-PubMedBERT-NER-Disease', type=str,  # required=True,
    ...
    parser.add_argument('--connect_type', type=str, default='mlp-att', help="window list")
